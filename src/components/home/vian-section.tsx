...
import { IconSparkles, IconCpu, IconBolt, IconBrain } from "@tabler/icons-react";
...
export default function VianSection() {
  ...
  return (
    <div className="flex flex-col">
      <SectionHeading
        color="indigo"
        subtitle="AUTONOMOUS AGENTIC INTELLIGENCE"
      >
        Meet VIAN — AI Engineering Assistant
      </SectionHeading>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left max-w-xl">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <h3 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 dark:text-zinc-100">
                Portfolio Copilot & Technical Agent
              </h3>

              <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
                Interact with VIAN to explore system architectures, analyze production ML projects, schedule collaborations, draft inquiries, or execute technical workflows in real time.
              </p>
              ...
              <div className="pt-1 flex flex-wrap items-center justify-center sm:justify-start gap-4 text-xs text-slate-500 dark:text-zinc-400 font-mono">
                <span className="flex items-center gap-1.5">
                  <IconCpu className="h-3.5 w-3.5 text-cyan-500" /> Multi-Agent Reasoning
                </span>
                <span className="flex items-center gap-1.5">
                  <IconBolt className="h-3.5 w-3.5 text-cyan-500" /> Tool Execution
                </span>
                <span className="flex items-center gap-1.5">
                  <IconBrain className="h-3.5 w-3.5 text-cyan-500" /> Adaptive Memory
                </span>
              </div>
            </div>
          </div>
